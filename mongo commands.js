...
db.movies.find({ rating:{ $gt:8.5, $lt:9 }}, {_id:0, name:1, rating:1})

//sorting
//ASC
db.movies.find({ rating:{ $gt:8.5, $lt:9 }}, {_id:0, name:1, rating:1}).sort({rating: 1})
...
db.movies.find({ rating:{ $gt:8.5, $lt:9 }}, {_id:0, name:1, rating:1}).sort({rating: -1}).limit(3);


//skip (offset)

db.movies.find({ rating:{ $gt:8.5, $lt:9 }}, {_id:0, name:1, rating:1}).sort({rating: -1}).limit(3).skip(3); 
